...
if __name__ == '__main__':
    servicio = WService("Spooler")
    print servicio.infostartup()
    print servicio.infoctrl()
    print servicio.infotype()
    print servicio.status()
    print "-------------------------------------"
    servicio = WService("AdobeARMservice")
    print servicio.infostartup()
    print servicio.infoctrl()
    print servicio.infotype()
    print servicio.status()
    print "-------------------------------------"
    servicio = WService("Sumadre")
    if servicio.errores:
        print "no existe"
        sys.exit()
    print servicio.infostartup()
